...
const BLOG = {
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || 'Game | Tech | Invest', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://lucasyan.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客, 游戏, 投资, 科技', // 网站关键词 英文逗号隔开
